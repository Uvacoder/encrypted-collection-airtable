<template>
    <div id='watchlist'>
        <p>
            ...
            <br>
            If you find any products here that either no longer plan to offer encryption or should be in the main list, please <router-link to="/report">report them here <app-link-icon></app-link-icon></router-link>.
        </p>
